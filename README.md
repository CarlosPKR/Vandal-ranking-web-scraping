...
- /data: contiene el csv generado por el script, el ejemplo contiene 1000 registros a fecha de 7 de abril de 2026.
- /src: contiene el código fuente.
- main.py: Entrada a la ejecución del código.
- requeriments.txt: Para instalación de las dependencias.

El script generará un dataset contenido en la carpeta data con la siguiente información:
...
- /data: contains the CSV generated by the script; the example includes 1000 records as of April 7, 2026.
